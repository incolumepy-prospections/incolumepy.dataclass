...
Os campos de inicialização bloqueados podem ser preenchido post_init. E também
podem ser protegidos ou privados.

algo do tipo:
    Person(
       name='John', address='123 Main St', actived=True, email_address=[],
       id='IRPLBUMXIARO', _search_string='John 123 Main St'
    )
